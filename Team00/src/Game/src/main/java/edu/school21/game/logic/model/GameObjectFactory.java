...
public class GameObjectFactory {
    private GameObjectAttributes wallAttributes = new GameObjectAttributes('#', Ansi.BColor.MAGENTA);
    private GameObjectAttributes goalAttributes = new GameObjectAttributes('0', Ansi.BColor.BLUE);
    private GameObjectAttributes playerAttributes = new GameObjectAttributes('Q', Ansi.BColor.GREEN);
    private GameObjectAttributes enemyAttributes = new GameObjectAttributes('X', Ansi.BColor.RED);
    private GameObjectAttributes emptyAttributes = new GameObjectAttributes(' ', Ansi.BColor.YELLOW);
